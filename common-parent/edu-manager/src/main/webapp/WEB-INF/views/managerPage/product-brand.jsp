...
<div class="page-container">
    <div class="text-c">
        <form class="Huiform" target="_self">
            <input type="text" placeholder="品种名称" id="brandName" name="brandName" value="" class="input-text" style="width:120px">
            <span class="btn-upload form-group">
			<input class="input-text upload-url" type="text" name="uploadfile-2" id="uploadfile-2" readonly style="width:200px">
			<a href="javascript:void();" class="btn btn-primary upload-btn"><i class="Hui-iconfont">&#xe642;</i> 上传logo</a>
			<input type="file" multiple name="file-2" class="input-file" id="file-2" onchange="changeLogoImage(this);">
			</span> <span class="select-box" style="width:150px">
			<select id="brandPlaceid" class="select" name="brandclass" size="1">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            <%--<tr class="text-c">
                ...
                <td><img src="managerstyle/temp/brand/dongpeng.jpeg"></td>
                <td class="text-l"><img title="国内品牌" src="managerstyle/static/h-ui.admin/images/cn.gif"> 东鹏</td>
                <td class="text-l">东鹏陶瓷被评为“中国名牌”、“国家免检产品”、“中国驰名商标”、http://www.dongpeng.net/</td>
                <td class="f-14 product-brand-manage">
                    <a style="text-decoration:none" onClick="product_brand_edit('品牌编辑','codeing.jsp','1')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="active_del(this,'10001')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
            </tr>--%>
            </tbody>
        </table>
    </div>
...
<script type="text/javascript" src="managerstyle/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="managerstyle/lib/laypage/1.2/laypage.js"></script>
<script type="text/javascript" src="js/manager/product-brand.js"></script>
