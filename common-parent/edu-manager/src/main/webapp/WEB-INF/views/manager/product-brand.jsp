    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td><img src="${pageContext.request.contextPath}/managerstyle/temp/brand/dongpeng.jpeg"></td>
                <td class="text-l"><img title="国内品牌" src="${pageContext.request.contextPath}/managerstyle/static/h-ui.admin/images/cn.gif"> 东鹏</td>
