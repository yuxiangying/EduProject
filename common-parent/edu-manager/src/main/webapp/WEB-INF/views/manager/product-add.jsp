...
<head>
    ...
    <link href="${pageContext.request.contextPath}/managerstyle/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/managerstyle/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/managerstyle/lib/jquery.validation/1.14.0/validate-methods.js"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/managerstyle/lib/jquery.validation/1.14.0/messages_zh.js"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/managerstyle/lib/webuploader/0.1.5/webuploader.min.js"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/managerstyle/lib/ueditor/1.4.3/ueditor.config.js"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/managerstyle/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/managerstyle/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
